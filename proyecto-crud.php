...
<div id="users-contain" class="ui-widget">
 <center><h1>Proyecto CRUD - JQuery</h1>
...
<?php
  ...
  while ($row = $rs->fetch_assoc()){
    ...
    echo '<td><a href="#" class="editar" id="'.$row["id"].'">Editar</a> | <a href="#" class="eliminar" id="'.$row["id"].'">Eliminar</a></td></tr><tr>';
...
?>
  ...
  <div id="agregar">
    <p class="titulo">Todos los campors son requeridos.</p>
